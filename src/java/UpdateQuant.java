 ...
 * @author Anurag Sinha
 */
public class UpdateQuant extends HttpServlet {
    Connection oconn;
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            int n=Integer.parseInt(request.getParameter("newQuantity"));
            ...
            ost.setInt(1, n);
            ost.setString(2,isbn);
            //STEP 7: EXECUTING THE QUERY
            int ra = ost.executeUpdate();
            
            if (ra>0){
                oconn.close();
            response.sendRedirect("http://localhost:8080/LMS/WEBPAGES/SearchBooks.jsp?param=update");
            }
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(UpdateQuant.class.getName()).log(Level.SEVERE, null, ex);
